---
title: "Defining parameters to identify isotopologue peaks using most commong positive adducts for compounds in HMDB"
...
isotopologue peaks based on the negatively charged ions ([M+H]+, [M+K]+ and
[M+Na]+) of all compounds defined in the Human Metabolome Database
[HMDB](https://hmdb.ca).
...
write.table(hmdb_subst, file = paste0(dr_txt, "hmdb_subst_positive.txt"),
            sep = "\t", row.names = TRUE)
```
