...
subst_info <- data.frame(
  ...
  md = iso_data_sub$md[match(levels(f), iso_data_sub$isotopologue)],
  proportion = as.numeric(subst_proportion[match(levels(f), names(subst_proportion))]),
  proportion2 = as.numeric(subst_proportion_var2[match(levels(f), names(subst_proportion_var2))])
)
