---
title: "Defining parameters to identify isotopologue peaks using [M-H], [M+HCO2], [M+Na] from HMDB"
...
```{r, eval = !file.exists(paste0(dr, "subst_frequencies_all-neg.RData"))}
...
save(subst_frequency, subst_per_cmpd, 
     iso_ps, chemforms, file = paste0(dr, "subst_frequencies_all-neg.RData"))
```


```{r, echo = FALSE, eval = file.exists(paste0(dr, "subst_frequencies_all-neg.RData"))}
load(paste0(dr, "subst_frequencies_all-neg.RData"))
```
